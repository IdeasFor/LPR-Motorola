...
namespace Sdk
{
    ...
    public struct NET_SDK_DEVICEINFO
    {
        ...
        {
            return SdkHelper.IntToIp(deviceIP);
        }
        ...
        {
            return SdkHelper.ByteToStr(deviceName);
        }
        public string GetFirmwareVersion()
        {
            return SdkHelper.ByteToStr(firmwareVersion);
        }
        public string GetKernelVersion()
        {
            return SdkHelper.ByteToStr(kernelVersion);
        }
        public string GetHardwareVersion()
        {
            return SdkHelper.ByteToStr(hardwareVersion);
        }
        public string GetMCUVersion()
        {
            return SdkHelper.ByteToStr(MCUVersion);
        }
        public string GetFirmwareVersionEx()
        {
            return SdkHelper.ByteToStr(firmwareVersionEx);
        }
        public string GetDeviceProduct()
        {
            return SdkHelper.ByteToStr(deviceProduct);
        }
    ...
    public struct NET_SDK_CH_DEVICE_STATUS
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, ArraySubType = UnmanagedType.U1, SizeConst = SdkHelper.DD_MAX_CAMERA_NAME_BUF_LEN)]
        public byte[] name;
        [MarshalAs(UnmanagedType.ByValArray, ArraySubType = UnmanagedType.U1, SizeConst = 32)]
        public byte[] resv;				//暂时未用上
        ...
        {
            return SdkHelper.RemoveEmptyChar(Encoding.UTF8.GetString(name).Trim());
        }
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public struct RULE_POINT_LIST
    {
	    public RULE_POINT[] rule_point;
    }
    ...
    public struct NET_SDK_FACE_INFO_GROUP_ITEM
    {
         ...
         [MarshalAs(UnmanagedType.ByValArray, ArraySubType = UnmanagedType.U1, SizeConst = SdkHelper.DD_MAX_NAME_LEN)]
   ...
   [StructLayout(LayoutKind.Sequential, Pack = 4, CharSet = CharSet.Unicode)]
    ...
    public class SdkHelper
    {
        ...
        [DllImport(DVR_NET_SDK)]
        public static extern bool NET_SDK_ShowRect(int lPlayHandle,int x1,int x2,int y1,int y2 );
        
        [DllImport(DVR_NET_SDK)]
        public static extern bool NET_SDK_ShowRuleBoxList(int lPlayHandle, RULE_POINT_LIST rule_point);
        
        [DllImport(DVR_NET_SDK)]
        public static extern bool NET_SDK_ShowRectList(int lPlayHandle, IntPtr pVFDRectData, int nBufLen);
        ...
        public static IntPtr PointArrayToIntPtr(byte[] points)
        {
        ...
        {
            string strMsg = String.Format("error code: {0}", SdkHelper.NET_SDK_GetLastError());
            return strMsg;
        }
